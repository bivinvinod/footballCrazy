...
<head>
  ...
  <!-- Parsley -->
  <script type="text/javascript" src="https://cdn.jsdelivr.net/parsleyjs/2.4.3/parsley.min.js"></script>
  <!-- Moment JS | Date Range Picker Prerequisite (Must be loaded before daterangepicker.js or a TypeError is thrown) -->
  ...
  <script src="<?php echo base_url() ?>bower_components/sweetalert/dist/sweetalert.min.js"></script>
